/**
 * PDFViewer component - displays PDF summary
 */
  ...
  useEffect(() => {
    ...
    const fetchPdfBlob = async () => {
      ...
      try {
        ...
        const errorInfo = pdfLogger.handleApiError(err as any, "PDF generation", {
          selectedMeetingId,
        });
        pdfLogger.error("Error fetching PDF", err as any, {
          selectedMeetingId,
