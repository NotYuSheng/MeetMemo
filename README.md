...
A meeting transcription app that runs entirely offline. It converts speech to text, separates speakers (diarization), and generates summaries of discussions. Use it for meetings, interviews, lectures, or any audio where you need a clear transcript and summary.
