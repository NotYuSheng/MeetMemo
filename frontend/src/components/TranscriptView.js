  ...
  return (
    <div className="transcript-container">
      ...
      <div className="actions-group" style={{ marginBottom: '1rem' }}>
        <button
          onClick={() => selectedMeetingId && onIdentifySpeakers(selectedMeetingId)}
                ...
                {speakerSuggestions && 
                 ...
                 !speakerSuggestions[formatSpeakerName(entry.speaker)].toLowerCase().includes("cannot be determined") && (
                  <div className="speaker-suggestion">
                    ...
                    <button
                      onClick={() => onApplySpeakerSuggestion(entry.originalSpeaker, speakerSuggestions[formatSpeakerName(entry.speaker)])}
                      className="btn btn-success btn-small apply-suggestion-btn"
                    >
                      Apply
                    </button>
                    <button
                      onClick={() => onDismissSpeakerSuggestion(formatSpeakerName(entry.speaker))}
