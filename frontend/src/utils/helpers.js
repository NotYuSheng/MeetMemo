...
export const getDisplaySpeakerName = (currentSpeaker, originalSpeaker, speakerNameMap) => {
...
export const generateProfessionalFilename = (meetingTitle, type, includeDate = true) => {
